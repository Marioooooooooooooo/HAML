                ...
                if result["n/ep"] > 0:
                    if test_in_train and stop_fn and stop_fn(result["rew"]):
                        ...
                        if stop_fn(test_result["rew"]):
                            ...
                            policy.train()
                train_times = round(update_per_step * result["n/st"])
                losses = policy.ddpg_update(batch_size, train_collector.buffer, train_times)
                gradient_step += train_times
